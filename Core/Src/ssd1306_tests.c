...
/**
  * @brief  Function implementing to display the name.
  * @param  argument: none.
  * @retval None
  */
void ssd1306_myname(){
...
/**
  * @brief  Function to update the count.
  * @param  argument: count value from main.
  * @retval None
  */
void ssd1306_count(uint16_t count){
